...
then
  ...
  git clone https://github.com/ZEMUSHKA/ydata_pagaya.git /home/hadoop/ydata_pagaya
  # sudo cp /home/hadoop/ydata_pagaya/libboost_program_options.so.1.73.0 /usr/lib64/
fi
